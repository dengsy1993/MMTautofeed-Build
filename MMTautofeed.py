            ...
            if self.mode in ['publish', 'auto']:
                ...
                try:
                    ...
                    with open(torrent_path, "rb") as file_stream:
                        ...
                        headers = {"User-Agent": "MMTautofeed-Client/v1.0.7", "Cookie": self.config['cookie']}
...
class PTUploaderFullGUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MMTautofeed批量发种工具 (v1.0.7 稳定兼容版)")
    ...
    # 【完美复原丢失代码】：这里是被吃掉的 update_table_cell，保证多线程正确汇报状态！
